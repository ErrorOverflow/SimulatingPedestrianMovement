...
def gravity(loc):  # 驱动力
    ...
    if loc[0] >= 9.91:
        ...
        grav[0] = x_bias / z_bias * 0.06
        grav[1] = y_bias / z_bias * 0.06
...
def illegal_judge(loc, force):  # 墙排斥
    if (9.33 - 0.2) <= loc[0] <= 9.91 and (6.32 - 0.2) <= loc[1] <= (7.50 + 0.2):
        if loc[0] <= 9.33:
            ...
            force[1] = 0
        return force
    if (12.46 - (3.94 - 3.41) - 0.2) <= loc[0] <= 12.46 and 7.39 - 0.2 <= loc[1] <= 10.28:
        if loc[0] <= 12.46:
            force[0] = 0
        elif force[1] > 0:
            force[1] = 0
    if (12.46 - (3.94 - 3.41) - 0.2) <= loc[0] <= 12.46 and 3.21 - 0.2 <= loc[1] <= 6.39:
        if loc[0] <= 12.46:
            force[0] = 0
        elif force[1] < 0:
            force[1] = 0
